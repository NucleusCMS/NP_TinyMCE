...
define('_NP_TINYMCE_PLUGIN_DEAULTVALUE',   'visualblocks,autolink,save,advlist,style,fullscreen,advimage,paste,advlink,media,contextmenu,table');
define('_NP_TINYMCE_TOOLBAR_1_DEAULTVALUE',   'save,undo,redo,|,bold,italic,forecolor,backcolor,strikethrough,formatselect,fontsizeselect,pastetext,pasteword,code,fullscreen');
define('_NP_TINYMCE_TOOLBAR_2_DEAULTVALUE',   'image,media,link,unlink,anchor,|,justifyleft,justifycenter,justifyright,|,bullist,numlist,blockquote,outdent,indent,|,table,hr,|,visualblocks,styleprops,removeformat,|,help');
